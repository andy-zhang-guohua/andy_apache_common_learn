...
public class TestMathUsage {
    public static void main(String[] args) {
        ...
        System.out.println("mean: " + StatUtils.mean(values)); // Returns the arithmetic mean of the entries in the input array, or Double.NaN if the array is empty
        System.out.println("product: " + StatUtils.product(values)); //Returns the product of the entries in the input array, or Double.NaN if the array is empty.
        System.out.println("sum: " + StatUtils.sum(values)); //Returns the sum of the values in the input array, or Double.NaN if the array is empty.
        System.out.println("variance: " + StatUtils.variance(
                values)); // Returns the variance of the entries in the input array, or Double.NaN if the array is empty.
